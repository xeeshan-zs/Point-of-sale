...
This file contains the SQL commands to create the necessary databases and tables for the project.

## `point_of_sale` Database
...
(2, 'Nido', 'This is a Nido', 'product-1750331773.png', '0.00', 0, 41, '2025-06-19 13:16:13', '2025-06-19 13:16:13'),
(3, 'Kopiko', 'A coffee', 'product-1750331783.png', '0.00', 96, 41, '2025-06-19 13:16:23', '2025-06-19 13:16:23');
...
--
ALTER TABLE `sales_item`
  ADD CONSTRAINT `sales_item_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `sales_item_ibfk_2` FOREIGN KEY (`sales_id`) REFERENCES `sales` (`id`);
